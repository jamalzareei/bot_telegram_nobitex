...
<section id="data-list-view" class="data-list-view-header">
        ...
        <table class="table data-list-view">
            ...
            <tbody>
                @forelse ($settings as $setting)
                    <tr>
                        <td></td>
                        <td>{{ $setting->role->name ?? $setting->role_id }}</td>
                        <td>{{ $setting->type->name ?? $setting->type_id }}</td>
                        <td>{{ $setting->value }}</td>
                        <td>{{ $setting->details }}</td>
                        <td class="product-action">
                            <span class="action-edit" onclick="editRow('{{ route('panel.settings.edit.setting', ['id'=> $setting->id]) }}')"><i class="feather icon-edit"></i></span>
    ...
    <div class="add-new-data-sidebar">
        <div class="overlay-bg"></div>
            ...
            @include('panel.components.settings.add',[
